//intlTelInput
let input2 = document.querySelector(".phone-2"),
...
let iti = window.intlTelInput(input2, {
    utilsScript: 'js/registerForm/intlTelInput/js/utils.js',
    nationalMode: true,
    defaultCountry: 'auto',
    preferredCountries: ["kz", "ru", "by", "ge"],
...
let iti2 = window.intlTelInput(input3, {
    utilsScript: 'js/registerForm/intlTelInput/js/utils.js',
    nationalMode: true,
    defaultCountry: 'auto',
    preferredCountries: ["kz", "ru", "by", "ge"],
...
function checkValidation(target, itemForm) {
    ...
    switch (validType) {
        ...
        case 'phone':
            let checkNum = (iti.isValidNumber() || iti2.isValidNumber());
            let numPrefix = (iti.getSelectedCountryData().dialCode || iti2.getSelectedCountryData().dialCode);
            let getNum = (iti.getNumber() || iti2.getNumber());
            let getCountry = (iti.defaultCountry.toUpperCase() || iti2.defaultCountry.toUpperCase());
            let fullNameCountry = (iti.getSelectedCountryData().name.split(' ')[0] || iti2.getSelectedCountryData().name.split(' ')[0])
